    ...
    return (
        <div className='w-full h-full'>
            <div className="flex flex-col w-9/12 mx-auto mt-20 bg-green-100 shadow">
                {category.cover && <div className='relative mb-5 overflow-hidden bg-black h-80'><Image className='object-fill ' layout='fill' src={`${process.env.STRAPIHOST}${category.cover[0].url}`} /></div>}
